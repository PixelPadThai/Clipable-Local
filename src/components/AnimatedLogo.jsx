function AnimatedLogo({ position, isActive, areaName }) {
  return (
    <div className={`animated-logo ${position} ${isActive ? 'active' : ''}`}>
      ...
      >
        <defs>
          <linearGradient id="clipboard-gradient" x1="11.736" x2="19.072" y1="8.218" y2="27.867" gradientUnits="userSpaceOnUse">
            <stop offset="0.025" stopColor="#FF8E63"></stop>
            <stop offset="0.56" stopColor="#FF7EB0"></stop>
            <stop offset="0.95" stopColor="#4B73FF"></stop>
          </linearGradient>
          
          <mask id="clipboard-mask" width="32" height="32" x="0" y="0" maskUnits="userSpaceOnUse" style={{maskType: 'alpha'}}>
            <g fill="url(#clipboard-gradient)">
          ...
          <filter id="blue-blur" width="45.444" height="46.274" x="-8.638" y="-6.326" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
            <feGaussianBlur result="effect1_foregroundBlur" stdDeviation="3.58"></feGaussianBlur>
          </filter>
          
          <filter id="pink-blur" width="54.181" height="46.274" x="-11.297" y="-15.094" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
            <feGaussianBlur result="effect1_foregroundBlur" stdDeviation="3.58"></feGaussianBlur>
          </filter>
          
          <filter id="red-blur" width="45.444" height="42.383" x="-3.677" y="-16.154" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
            <feGaussianBlur result="effect1_foregroundBlur" stdDeviation="3.58"></feGaussianBlur>
          </filter>
          
          <filter id="orange-blur" width="33.038" height="33.538" x="-0.448" y="-8.73" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
            <feGaussianBlur result="effect1_foregroundBlur" stdDeviation="3.58"></feGaussianBlur>
          </filter>
        ...
        <g mask="url(#clipboard-mask)">
          <g filter="url(#blue-blur)">
            <ellipse cx="14.084" cy="16.811" fill="#4B73FF" rx="15.562" ry="15.977"></ellipse>
          </g>
          <g filter="url(#pink-blur)">
            <ellipse cx="15.794" cy="8.043" fill="#FF66F4" rx="19.931" ry="15.977"></ellipse>
          </g>
          <g filter="url(#red-blur)">
            <ellipse cx="19.045" cy="5.037" fill="#FF0105" rx="15.562" ry="14.031"></ellipse>
          </g>
          <g filter="url(#orange-blur)">
            <ellipse cx="16.071" cy="8.039" fill="#FE7B02" rx="9.359" ry="9.608"></ellipse>
          </g>
        </g>
      </svg>
    </div>
